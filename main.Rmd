...
fig <- data %>% 
  ...
  theme_minimal()
ggsave("res/aviones_acc.pdf", fig)
```
...
fig <- data %>%
  ...
  theme_minimal()
ggsave("res/muertes_bor.pdf", fig)
```
...
fig <- data %>%
  ...
  theme_minimal()
ggsave("res/tasa_muertes.pdf", fig)
```
